...
class MixewayTestingApplicationTests {

    @Test
    void contextLoads() throws IOException, GitAPIException, InterruptedException {
        ...
        install = new ProcessBuilder("cmd", "dir").inheritIO();
        install.environment().putAll(System.getenv());
        Process freezeProcess = install.start();
